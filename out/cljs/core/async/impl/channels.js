...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12321 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12321 = (function (val,box,meta12322){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12321.cljs$lang$type = true;
cljs.core.async.impl.channels.t12321.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12321";
cljs.core.async.impl.channels.t12321.cljs$lang$ctorPrWriter = (function (this__4118__auto__,writer__4119__auto__,opt__4120__auto__){return cljs.core._write.call(null,writer__4119__auto__,"cljs.core.async.impl.channels/t12321");
});
cljs.core.async.impl.channels.t12321.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12321.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12323){var self__ = this;
var _12323__$1 = this;return self__.meta12322;
});
cljs.core.async.impl.channels.t12321.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12323,meta12322__$1){var self__ = this;
var _12323__$1 = this;return (new cljs.core.async.impl.channels.t12321(self__.val,self__.box,meta12322__$1));
});
cljs.core.async.impl.channels.__GT_t12321 = (function __GT_t12321(val__$1,box__$1,meta12322){return (new cljs.core.async.impl.channels.t12321(val__$1,box__$1,meta12322));
});
}
return (new cljs.core.async.impl.channels.t12321(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12324 = self__.takes.pop();if((taker_12324 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12324))
{var take_cb_12325 = cljs.core.async.impl.protocols.commit.call(null,taker_12324);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12325,taker_12324,this$__$1){
return (function (){return take_cb_12325.call(null,null);
});})(take_cb_12325,taker_12324,this$__$1))
);
} else
{}
{

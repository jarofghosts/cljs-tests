...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12315 = (0);while(true){
var m_12316 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12316 == null))
{} else
{m_12316.call(null);
if((count_12315 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12317 = (count_12315 + (1));
count_12315 = G__12317;
continue;
}
} else
{}

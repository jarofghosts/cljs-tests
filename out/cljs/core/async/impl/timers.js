...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_12222 = (0);while(true){
if((i_12222 < arr.length))
{(arr[i_12222] = null);
{
var G__12223 = (i_12222 + (1));
i_12222 = G__12223;
continue;
}
} else
...
{var i_12229 = (self__.level + (1));while(true){
if((i_12229 <= (new_level + (1))))
{(update[i_12229] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12231 = (0);while(true){
if((i_12231 <= self__.level))
{var links_12232 = (update[i_12231]).forward;if(((links_12232[i_12231]) === x__$1))
{(links_12232[i_12231] = (x__$1.forward[i_12231]));
{
var G__12233 = (i_12231 + (1));
i_12231 = G__12233;
continue;
}
} else
{{
var G__12234 = (i_12231 + (1));
i_12231 = G__12234;
continue;
}
}
